...
Insert all images from the `images` directory into the page code.

Each image should have the correct `src` attribute with the appropriate path (e.g. `images/photo1.jpg`) and an `alt` attribute with text.
